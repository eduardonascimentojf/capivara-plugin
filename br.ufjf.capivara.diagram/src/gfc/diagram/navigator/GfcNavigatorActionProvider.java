...
import gfc.diagram.part.GfcDiagramEditor;
 ...
 * @generated
 */
public class GfcNavigatorActionProvider extends CommonActionProvider {
		...
		*/
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof GfcNavigatorItem) {
					selectedElement = ((GfcNavigatorItem) selectedElement).getView();
				} else if (selectedElement instanceof IAdaptable) {
					selectedElement = ((IAdaptable) selectedElement).getAdapter(View.class);
				}
				if (selectedElement instanceof Diagram) {
					Diagram diagram = (Diagram) selectedElement;
					if (FlowchartEditPart.MODEL_ID.equals(GfcVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
