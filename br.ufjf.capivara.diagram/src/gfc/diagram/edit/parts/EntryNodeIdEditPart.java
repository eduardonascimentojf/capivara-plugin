 ...
 * @generated
 */
public class EntryNodeIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EntryNodeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GfcParserProvider.getParser(GfcElementTypes.EntryNode_2001, getParserElement(),
					GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.EntryNodeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
