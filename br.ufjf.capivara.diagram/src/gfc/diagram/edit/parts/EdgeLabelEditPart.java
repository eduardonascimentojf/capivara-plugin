...
public class EdgeLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.EdgeLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GfcParserProvider.getParser(GfcElementTypes.Edge_4001, getParserElement(),
					GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.EdgeLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
