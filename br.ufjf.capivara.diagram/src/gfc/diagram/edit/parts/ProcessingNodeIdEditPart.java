 ...
 * @generated
 */
public class ProcessingNodeIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ProcessingNodeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GfcParserProvider.getParser(GfcElementTypes.ProcessingNode_2002, getParserElement(),
					GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.ProcessingNodeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
