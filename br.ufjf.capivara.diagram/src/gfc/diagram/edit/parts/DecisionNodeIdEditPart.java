 ...
 * @generated
 */
public class DecisionNodeIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DecisionNodeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GfcParserProvider.getParser(GfcElementTypes.DecisionNode_2003, getParserElement(),
					GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.DecisionNodeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
