 ...
 * @generated
 */
public class CaseNodeIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CaseNodeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GfcParserProvider.getParser(GfcElementTypes.CaseNode_2007, getParserElement(),
					GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.CaseNodeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
