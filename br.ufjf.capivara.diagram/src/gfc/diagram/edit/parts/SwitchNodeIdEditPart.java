 ...
 * @generated
 */
public class SwitchNodeIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SwitchNodeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GfcParserProvider.getParser(GfcElementTypes.SwitchNode_2006, getParserElement(),
					GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.SwitchNodeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
