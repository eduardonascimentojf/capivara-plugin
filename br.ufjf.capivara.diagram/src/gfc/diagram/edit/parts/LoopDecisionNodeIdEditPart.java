 ...
 * @generated
 */
public class LoopDecisionNodeIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LoopDecisionNodeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GfcParserProvider.getParser(GfcElementTypes.LoopDecisionNode_2004, getParserElement(),
					GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.LoopDecisionNodeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, GfcEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
