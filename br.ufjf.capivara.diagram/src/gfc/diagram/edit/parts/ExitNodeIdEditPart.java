 ...
 * @generated
 */
public class ExitNodeIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExitNodeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = GfcParserProvider.getParser(GfcElementTypes.ExitNode_2005, getParserElement(),
					GfcVisualIDRegistry.getType(gfc.diagram.edit.parts.ExitNodeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
