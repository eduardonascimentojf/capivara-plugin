...
public class EdgeReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return GfcBaseItemSemanticEditPolicy.getLinkConstraints().canExistEdge_4001(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Flowchart container = (Flowchart) getLink().eContainer();
		return GfcBaseItemSemanticEditPolicy.getLinkConstraints().canExistEdge_4001(container, getLink(), source,
				getNewTarget());
	}
