 ...
 * @generated
 */
public class GfcValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof GfcDiagramEditor) {
