 ...
 * @generated
 */
public class GfcMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			GfcDiagramEditorUtil.selectElementsInDiagram(editor, Arrays.asList(new EditPart[] { targetEditPart }));
		}
	}
