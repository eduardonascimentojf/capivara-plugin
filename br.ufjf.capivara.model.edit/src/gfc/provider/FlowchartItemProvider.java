...
/**
 * This is the item provider adapter for a {@link gfc.Flowchart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowchartItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GfcPackage.Literals.FLOWCHART__NODES);
			childrenFeatures.add(GfcPackage.Literals.FLOWCHART__EDGES);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(GfcPackage.Literals.FLOWCHART__NODES,
				 GfcFactory.eINSTANCE.createEntryNode()));

		newChildDescriptors.add
			(createChildParameter
				(GfcPackage.Literals.FLOWCHART__NODES,
				 GfcFactory.eINSTANCE.createProcessingNode()));

		newChildDescriptors.add
			(createChildParameter
				(GfcPackage.Literals.FLOWCHART__NODES,
				 GfcFactory.eINSTANCE.createDecisionNode()));

		newChildDescriptors.add
			(createChildParameter
				(GfcPackage.Literals.FLOWCHART__NODES,
				 GfcFactory.eINSTANCE.createLoopDecisionNode()));

		newChildDescriptors.add
			(createChildParameter
				(GfcPackage.Literals.FLOWCHART__NODES,
				 GfcFactory.eINSTANCE.createExitNode()));
